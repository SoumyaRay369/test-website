    ...
    return (
        <>
            <div className='mt-10 flex justify-center gap-x-5'>
                ...
                <button onClick={() => setSelectedField('analytics')} className='bg-blue-500 hover:bg-blue-600 font-garamond rounded-xl p-2 text-white font-medium'>Data Analytics</button>
